...
with open('class7_math_comparing_data.txt', 'r', encoding='utf-8') as f:
    comp_data = f.read()

with open('class7_math_comparing_jsx.txt', 'r', encoding='utf-8') as f:
    comp_jsx = f.read()
