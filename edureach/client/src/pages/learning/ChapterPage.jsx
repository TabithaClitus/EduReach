        ...
        chapters: [
            {
                id: 'reading-comprehension',
                title: 'Reading Comprehension',
                description: 'Read and analyze complex passages to improve understanding.',
                emoji: '📖',
                bgColor: '#E3F2FD',
                iconBg: '#90CAF9',
            },
            {
                id: 'grammar-tenses',
                title: 'Grammar: Tenses & Voice',
                description: 'Master advanced tenses, active/passive voice, and direct/indirect speech.',
                emoji: '📝',
                bgColor: '#FFF9C4',
                iconBg: '#FFF176',
            },
            {
                ...
                description: 'Enjoy and analyze classic short stories and their morals.',
                emoji: '📚',
                bgColor: '#C8E6C9',
                iconBg: '#A5D6A7',
            },
            {
                ...
                description: 'Learn letter writing, essay writing, and story development.',
                emoji: '✏️',
                bgColor: '#F8BBD0',
                iconBg: '#F48FB1',
            },
        ...
        chapters: [
            {
                ...
                description: 'Introduction to history and finding out about the past.',
                emoji: '📜',
                bgColor: '#D1C4E9',
                iconBg: '#B39DDB',
            },
            {
                ...
                description: 'Hunter-gatherers to farmers and early civilizations.',
                emoji: '🏕️',
                bgColor: '#B3E5FC',
                iconBg: '#81D4FA',
            },
            {
                ...
                description: 'Planets, stars, asteroids, and our place in space.',
                emoji: '🌍',
                bgColor: '#C8E6C9',
                iconBg: '#A5D6A7',
            },
            {
                ...
                title: 'Globe: Latitudes & Longitudes',
                description: 'Understanding the grid system, time zones, and equator.',
                emoji: '🌐',
                bgColor: '#FFE0B2',
                iconBg: '#FFCC80',
            },
            {
                ...
                description: 'Learn about different cultures, religions, and unity in diversity.',
                emoji: '🤝',
                bgColor: '#DCEDC8',
                iconBg: '#AED581',
            },
            {
                ...
                description: 'Panchayati Raj, rural and urban administration.',
                emoji: '🏛️',
                bgColor: '#FFF9C4',
                iconBg: '#FFF59D',
            },
        ...
        chapters: [
            {
                ...
                description: 'Hardware, software, memory, and processing.',
                emoji: '🖥️',
                bgColor: '#EDE7F6',
                iconBg: '#D1C4E9',
            },
            {
                ...
                description: 'How the internet works, creating and sending emails safely.',
                emoji: '📧',
                bgColor: '#E3F2FD',
                iconBg: '#90CAF9',
            },
            {
                id: 'advanced-word-processing',
                title: 'Advanced Word Processing',
                description: 'Formatting, tables, and professional documents.',
                emoji: '📄',
                bgColor: '#E8F5E9',
                iconBg: '#A5D6A7',
            },
            {
                id: 'intro-to-presentations',
                title: 'Creating Presentations',
                description: 'Using slides, animations, and transitions.',
                emoji: '📊',
                bgColor: '#FFF9C4',
                iconBg: '#FFF176',
            },
            {
                ...
                description: 'Algorithms, flowcharts, and basic block coding.',
                emoji: '👨‍💻',
                bgColor: '#FFCDD2',
                iconBg: '#EF9A9A',
            },
            {
                id: 'cyber-safety',
                title: 'Cyber Safety',
                description: 'Protecting identity, avoiding malware, and netiquette.',
                emoji: '🛡️',
                bgColor: '#FFE0B2',
                iconBg: '#FFCC80',
            },
