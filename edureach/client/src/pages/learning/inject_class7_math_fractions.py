...
data_path = 'class7_math_fractions_data.txt'
jsx_path = 'class7_math_fractions_jsx.txt'
...
print("Successfully injected Class 7 Mathematics - Fractions & Decimals lesson.")
